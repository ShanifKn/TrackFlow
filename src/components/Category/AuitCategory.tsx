...
const AuitCategory = () => {
  ...
  return (
    <div className="my-5 bg-white p-4 rounded gap-4 h-fit">
      <h1 className="font-semibold text-black text-xl tracking-wide pb-4">Audit Category List</h1>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button className="text-white bg-[#006666] hover:bg-emerald-800">Add Audit Category</Button>
      </div>
