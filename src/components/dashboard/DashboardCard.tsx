  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-6 ">
      <div className="p-6 rounded-lg shadow-md flex items-center justify-between border-b-8 border-teal-100 ">
        <div className="flex gap-4 items-center justify-between w-full">
          <div className="grid gap-3">
            ...
            <h1 className="text-2xl text-black font-semibold">1,532</h1>
          </div>
        ...
        <div className="flex gap-4 items-center justify-between w-full">
          <div className="grid gap-3">
            ...
            <h1 className="text-2xl text-black font-semibold">
              25,1234 <span className="text-sm text-gray-400"></span>
            </h1>
          </div>
      ...
      <div className="p-6 rounded-lg shadow-md flex items-center justify-between border-b-8 border-gray-200 ">
        <div className="flex gap-4 items-center justify-between w-full">
          <div className="grid gap-3">
            <h4 className="text-lg text-gray-700 font-medium">Total Asset Cost</h4>
            <h1 className="text-2xl text-black font-semibold">25,1231</h1>
          </div>
      ...
      <div className="p-6 rounded-lg shadow-md flex items-center justify-between border-b-8 border-yellow-200 ">
        <div className="flex gap-4 items-center justify-between w-full">
          <div className="grid gap-3">
            <h4 className="text-lg text-gray-700 font-medium">Total Depreciation</h4>
            <h1 className="text-2xl text-black font-semibold">15,1231</h1>
          </div>
