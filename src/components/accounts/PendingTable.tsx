...
const PendingTable: React.FC<PurchaseTableProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white my-10">
      ...
      <div className="flex items-center justify-between mb-4">
        <input
          type="text"
          placeholder="Search by po, date or branch"
        ...
        <table className="min-w-full table-auto border-collapse border border-gray-200 shadow-lg rounded-lg">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 border border-gray-200 text-center">Invoiced</th>
          ...
          <tbody>
            {paginatedUsers.map((user: any, index: number) => (
              <tr
                ...
                <td className="px-4 py-2 border border-gray-200 text-center text-red-500">false</td>
